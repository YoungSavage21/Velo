            ...
            <div class="card mb-4">
                ...
                <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                    <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                        <img src="<?= base_url('assets'); ?>/img/avatars/14.png" alt="user image"
                        ...
                        <div
                            ...
                            <div class="user-profile-info">
                                ...
                                <ul
                                    ...
                                    <li class="list-inline-item"><i class="ti ti-color-swatch"></i> Web Developer</li>
                                    <li class="list-inline-item"><i class="ti ti-map-pin"></i>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-users"></i><span class="fw-bold mx-2">Ongoing Task:</span>
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex flex-wrap">
                                    <div class="avatar me-2">
                                        <img src="<?= base_url('assets'); ?>/img/avatars/3.png" alt="Avatar"
                        ...
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                ...
                                <p class="mb-2">
                                    ...
                                    <img src="<?= base_url('assets'); ?>/img/avatars/4.png" class="rounded-circle me-3"
                                        alt="avatar" height="24" width="24" />
                                </p>
                                <div class="d-flex flex-wrap gap-2 pt-1">
                                    <a href="javascript:void(0)" class="me-3">
                                        <img src="<?= base_url('assets'); ?>/img/icons/misc/doc.png"
                                            alt="Document image" width="15" class="me-2" />
                                        <span class="fw-semibold text-heading">App Guidelines</span>
                                    </a>
                                    <a href="javascript:void(0)">
                                        <img src="<?= base_url('assets'); ?>/img/icons/misc/xls.png" alt="Excel image"
                                            width="15" class="me-2" />
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="mb-3">
                                    <div class="d-flex align-items-start">
                                        <div class="d-flex align-items-start">
                                            <div class="avatar me-2">
                                                <img src="<?= base_url('assets'); ?>/img/avatars/10.png" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                            <div class="me-2 ms-1">
                                ...
                                <li class="mb-3">
                                    <div class="d-flex align-items-start">
                                        <div class="d-flex align-items-start">
                                            <div class="avatar me-2">
                                                <img src="<?= base_url('assets'); ?>/img/avatars/12.png" alt="Avatar"
                                                    class="rounded-circle" />
                                            </div>
                                            <div class="me-2 ms-1">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-3">
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex align-items-start">
                                            <div class="avatar me-2">
                                                <img src="<?= base_url('assets'); ?>/img/icons/brands/react-label.png"
                                ...
                                <li class="mb-3">
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex align-items-start">
                                            <div class="avatar me-2">
                                                <img src="<?= base_url('assets'); ?>/img/icons/brands/support-label.png"
                                                    alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div class="me-2 ms-1">
                                ...
                                <li class="mb-3">
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex align-items-start">
                                            <div class="avatar me-2">
                                                <img src="<?= base_url('assets'); ?>/img/icons/brands/figma-label.png"
                                                    alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div class="me-2 ms-1">
                                ...
                                <li class="mb-3">
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex align-items-start">
                                            <div class="avatar me-2">
                                                <img src="<?= base_url('assets'); ?>/img/icons/brands/vue-label.png"
                                                    alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div class="me-2 ms-1">
                                ...
                                <li class="mb-3">
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex align-items-start">
                                            <div class="avatar me-2">
                                                <img src="<?= base_url('assets'); ?>/img/icons/brands/twitter-label.png"
                                                    alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div class="me-2 ms-1">
